...
import com.jike.shanglv_b.Common.*;
import com.jike.shanglv_b.Enums.*;
	...
	View.OnClickListener btnClickListner = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			cityIntent.setClass(context,
					com.jike.shanglv_b.SeclectCity.AirportInternationalCityActivity.class);
			...
			case R.id.startdate_tv:// 往返 开始日期
				dateIntent.putExtra(com.jike.shanglv_b.ShipCalendar.MainActivity.TITLE, "出发日期");
				startActivityForResult(dateIntent, startdate);
				break;
			case R.id.enddate_tv:// 往返 返程日期
				dateIntent.putExtra(com.jike.shanglv_b.ShipCalendar.MainActivity.TITLE, "返程日期");
