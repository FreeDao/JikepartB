...
import com.jike.shanglv_b.Common.IDCard;
import com.jike.shanglv_b.Enums.PackageKeys;
import com.jike.shanglv_b.Enums.SPkeys;
import com.jike.shanglv_b.Models.HotelRoom;
import com.jike.shanglv_b.Models.HotelRoomComfirm;
...
public class ActivityHotelBooking extends Activity {
	...
	private com.jike.shanglv_b.Common.ClearEditText name_cet1, name_cet2,
	...
	View.OnClickListener clickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.ruzhu_date_ll:
				...
				dateIntent.putExtra(com.jike.shanglv_b.ShipCalendar.MainActivity.TITLE, "入住日期");
			...
			case R.id.lidian_date_ll:
				...
				dateIntent1.setClass(context,
						com.jike.shanglv_b.ShipCalendar.MainActivity.class);
				dateIntent1.putExtra(com.jike.shanglv_b.ShipCalendar.MainActivity.TITLE, "离店日期");
